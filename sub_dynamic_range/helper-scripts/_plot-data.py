...
for progname in ["hash", "point", "range"]:
    ...
    ax.scatter(lengths_qp, times_qp, color=col_map[progname], marker="o", label=progname + " (QP)")
    ax.scatter(lengths_ln, times_ln, color=col_map[progname], marker="^", label=progname + " (LN)")

plt.legend(loc="lower right")
plt.savefig("..\\paper\\images\\figure3.png", bbox_inches="tight")